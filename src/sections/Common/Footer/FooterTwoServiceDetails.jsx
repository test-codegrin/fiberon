                ...
                <div className="footer-top-1">
                    ...
                    <div className="subscribe-box">
                        ...
                        <form className="newsletter-form">
                            ...
                            <button type="submit" className="btn btn-footer-two style2">SUBSCRIBE<i className="ri-arrow-right-up-line"></i></button>
                        </form>
                    </div>
                </div>
                    ...
                    <div className="row justify-content-between">
                        <div className="col-md-6 col-xl-3">
                            <div className="widget widget-about footer-widget">
                                ...
                                <p className="about-text">A small business can be better than a big business because of agility and adaptability due to their size and scale.</p>
                                <h4 className="about-year">Since 2000</h4>
                                <h5 className="about-subtitle">WE ARE AVAILABLE</h5>
                                <p className="about-text"><span className="text-theme">Mon-Sat:</span> 10:00am to 07:30pm</p>
                            </div>
                        </div>
                            ...
                            <div className="widget widget_nav_menu footer-widget">
                                ...
                                <div className="menu-all-pages-container grid-style">
                                    ...
                                    <ul className="menu">
                                        ...
                                        <li><Link href="/pages/innerpage/terms">Terms of use</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6 col-xl-auto">
                            <div className="widget footer-widget widget-contact">
                                ...
                                <p className="contact-text">Los Angeles, Street Road 24, New York, USA - 67452</p>
                                <h3 className="widget_title">Email Address</h3>
                                <p className="text-white footer-text">Get in Touch!</p>
                                <p className="footer-text"><Link href="mailto:support@gmail.com">support@gmail.com</Link></p>
                            </div>
                        </div>
                        <div className="col-md-6 col-xl-auto">
            ...
            <div className="container">
                <div className="copyright-wrap">
                    <div className="row gy-3 justify-content-md-between justify-content-center">
                        <div className="col-auto align-self-center"><p className="copyright-text text-center">© 2024 <Link href="#">Construz</Link> | All rights reserved</p></div>
