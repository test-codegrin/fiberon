                                ...
                                <div className="widget widget_nav_menu footer-widget">
                                    ...
                                    <div className="menu-all-pages-container grid-style">
                                        <ul className="menu">
                                            ...
                                            <li><Link href="/pages/innerpage/service">News & Article</Link></li>
                                            <li><Link href="/pages/innerpage/service">Success Story</Link></li>
                                            <li><Link href="/pages/innerpage/service">FAQ’s</Link></li>
                                        </ul>
                                        <ul className="menu">
                                            <li><Link href="/pages/innerpage/team">Our Team</Link></li>
                                            <li><Link href="/pages/innerpage/service">Careers</Link></li>
                                            <li><Link href="/pages/innerpage/service">Testimonials</Link></li>
                                            <li><Link href="/pages/innerpage/contact">Privacy Policy</Link></li>
                                            <li><Link href="/pages/innerpage/contact">Terms of use</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
