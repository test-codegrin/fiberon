      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="">
          <div className="">
            ...
            <p className="text-gray-700 leading-relaxed mb-10">
              ...
              maintain buildings under permanent use conditions. The
              construction industry tackles three enduring issues including
              environmental pressure together with structural wear-out and
              material damage. The lifetime costs of projects increases because
              steel material suffers from corrosion and requires intensive
              maintenance in environmental conditions. The requirements for
              improved reinforcement solutions become evident because GFRP Rebar
              provides a superior combination of strength with durability.
            </p>
          </div>
          ...
          <div className="">
            ...
            <p className="text-gray-700 leading-relaxed mb-10">
              ...
              together with better durability and economic performance. The
              materials involved in bridge and building construction and highway
              and marine construction need to demonstrate reliable performance
              under stress and environmental conditions and weight-bearing
              loads. The structural integrity suffers when weak materials or
              insufficient reinforcement measures are used because they make
              structures vulnerable to significant damage. GFRP bars enable
              engineers and builders to attain both reliable structural
              performance and assurance about their work because of these
              materials’ selection capabilities.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              ...
              construction projects use GFRP rebar because it offers corrosion
              resistance together with high tensile strength and lightweight
        ...
        <div className="">
          ...
          <p>
            ...
            and their capability to resolve enduring construction material
            problems. These are the main benefits that define GFRP bar
            superiority:
          </p>
        ...
        <div className="">
          ...
          <p>
            ...
            industry with indispensable components because of their ability to
            adapt to multiple needs and their structural strength.
          </p>
          ...
          <div className="space-y-3 mb-16">
            ...
            <li>
              Premium nonconductivity properties support their safe use in
              electrically energized underground infrastructure such as tunnels.
            </li>

            <li>
              The Indian GFRP rebar manufacturers heavily utilize this material
              throughout road construction projects because of its excellent
              performance characteristics in challenging environments.
            </li>

            <li>
              Water Treatment Plants: Resistant to harsh chemicals and constant
              moisture.
            </li>
          </div>
        </div>
        ...
        <div className="">
          ...
          <p className="text-gray-700">
            ...
            Construction structures use GFRP due to its higher tensile strength
            to weight ratio which surpasses the performance of steel for
            load-bearing applications. GFRP demonstrates resistance to corrosion
            because it does not deteriorate while steel rebars reduce in
            strength due to corrosion processes
          </p>

          <p>
            Structures reinforced with GFRP exhibit long-term service due to its
            non-corrosive properties. The material cost of maintaining steel
            rebars includes rust prevention while GFRP needs no upkeep
            whatsoever. The thermal conductivity of GFRP remains low which
            results in thermal stability during temperature fluctuations.
          </p>
        </div>
        ...
        <div className="">
          ...
          <p className="text-gray-700">
            ...
            effectiveness. GFRP exhibits three key advantages because it
            combines weight efficiency with high tensile power which surpasses
            steel reinforcement while withstanding corrosion damage. GFRP bars
            prove exceptional in every strength-critical infrastructure
            application including bridges, roads and industrial flooring.
            Construction projects require sustainable longevity which can be
            achieved by selecting glass fiber reinforced polymer rebars as an
            investment.
          </p>
        </div>
      </div>
