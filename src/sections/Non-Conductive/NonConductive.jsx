      ...
      <div className="max-w-[1400px]  mx-auto px-6">
        ...
        <div className="">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            applications to prevent the flow of electrical current, reducing the
            risk of electrical hazards and ensuring safety.
          </p>

          <p>
            In the ever-evolving world of Construction and infrastructure
            development, innovation and sustainability are the cornerstones of
            progress. GFRP (Glass Fiber Reinforced Polymer) Rebar is at the
            forefront of this revolution, offering a wide range of advantages.
            One of its standout features is its non-conductive nature, which
            makes it an invaluable material in various applications where
        ...
        <div className="">
          ...
          <p>
            ...
            variety of reasons. Here are some key importance of non-conductive
        ...
        <div className="">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            ...
            various properties which make it an ideal choice for Construction.
            Here’s why GFRP Rebar is a non-conductive material.
          </p>
          ...
          <ol className="list-decimal pl-5 space-y-5 text-gray-700 leading-relaxed mb-10">
            ...
            <li>
              ...
              electronic equipment is in use. This is particularly important in
              facilities such as hospitals, laboratories, data centres, and
              manufacturing plants where EMI can disrupt electronic systems.
            </li>
          </ol>
        </div>
      </div>
